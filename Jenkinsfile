 node {
        ...
        stage("Deploy To Pcf") {
                sh 'ssh rig@52.168.175.97 cf push --no-start -n productMicroservice;cf create-service p.mysql db-small  myservice;cf bind-service product  myservice;cf start product;'
    }
}
